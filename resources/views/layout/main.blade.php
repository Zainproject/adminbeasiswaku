                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ $totalPendaftar }}</h1>
                                        <div class="mb-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-0">
                                            <span class="text-muted">Total Beasiswa</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col mt-0">
                                                <h5 class="card-title">Penyedia Beasiswa</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="stat text-primary">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ $totalPenyedia }}</h1>
                                        <div class="mb-0">
                                            <span class="text-muted">Total Penyedia</span>
                                        </div>
                                    </div>
                                </div>
