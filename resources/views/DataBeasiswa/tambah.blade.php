...
@section('main')
    <main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>Tambah</strong> Beasiswa</h1>
            <div class="row">
                <div class="col-12">
                    <div class="card flex-fill">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Form Tambah Beasiswa</h5>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('beasiswa.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_beasiswa" name="nama_beasiswa"
                                        value="{{ old('nama_beasiswa') }}" required>
                                    @error('nama_beasiswa')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_penerima" name="jumlah_penerima"
                                        value="{{ old('jumlah_penerima') }}" min="1" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="penyediabeasiswa_id" id="penyediabeasiswa_id" class="form-select"
                                        required>
                                        <option value="">-- Pilih Penyedia --</option>
                                        @foreach ($penyedia as $p)
                                            <option value="{{ $p->id }}"
                                                {{ old('penyediabeasiswa_id') == $p->id ? 'selected' : '' }}>
                                                {{ $p->nama_penyedia }}
                                            </option>
                                        @endforeach
                                    </select>
